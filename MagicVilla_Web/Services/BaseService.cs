    ...
    public class BaseService : IBaseService
    {
        ...
        public async Task<T> SendAsync<T>(APIRequest apiRequest, bool withBearer = true)
        {
            try
            {
                ...
                var messageFactory = () => { return _apiMessageRequestBuilder.Build(apiRequest); };
            ...
            Func<HttpRequestMessage> httpRequestMessageFactory, bool withBearer = true)
        {
            ...
            else
            {
                ...
                catch (HttpRequestException httpRequestException)
                {
                    ...
                    {
                        // refresh token & retry the request
                        await InvokeRefreshTokenEndpoint(httpClient, tokenDTO.AccessToken, tokenDTO.RefreshToken);
                        return await httpClient.SendAsync(httpRequestMessageFactory());
                    }
        ...
        #region INVOKE REFRESH TOKEN ENDPOINT

        private async Task InvokeRefreshTokenEndpoint(HttpClient httpClient, string existingAccessToken,
        ...
        #region SIGN IN WITH NEW TOKENS
